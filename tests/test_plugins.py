...
def plugin_manager(mocker):
    ...
    manager.dependencies = {'Plugin2': ['Plugin', 'Plugin1']}
    return manager
...
def test_load_success(plugin_manager, mocker):
    ...
    mocker.patch.object(plugin_manager.logger, 'info')
    ...
    # plugin_manager.logger.debug.assert_called_with
    # ("Loaded plugins: {'Plugin': <Mock id='...'>,
    # 'Plugin1': <Mock id='...'>, 'Plugin2': <Mock id='...'>}")
